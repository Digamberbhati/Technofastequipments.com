      ...
      <section className="bg-slate-400 py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-6">
          <div className="relative group overflow-hidden rounded-lg shadow-lg">
            <img src="https://i.postimg.cc/ZRfnb3Ys/Liquid-Metal-Detector.png" alt="Blog Image 1" className="w-full h-64 object-cover transform group-hover:scale-105 transition duration-300 ease-in-out" />
          ...
          {/* <!-- 3rd img --> */}
          <div className="relative group overflow-hidden rounded-lg shadow-lg">
            <img src="https://i.postimg.cc/zBLvfvLJ/Greavity-Feed-Metal-Detector.png" alt="Blog Image 3" className="w-full h-64 object-cover transform group-hover:scale-105 transition duration-300 ease-in-out" />
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out">
          ...
          {/* <!-- 4nd img --> */}
          <div className="relative group overflow-hidden rounded-lg shadow-lg">
            <img src="https://i.postimg.cc/BZKt989p/Industrial-Metal-Detector.png" alt="Blog Image 2" className="w-full h-64 object-cover transform group-hover:scale-105 transition duration-300 ease-in-out" />
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out">
          ...
          {/* <!-- 5nd img --> */}
          <div className="relative group overflow-hidden rounded-lg shadow-lg">
            <img src="https://i.postimg.cc/rwPLwJ5r/Tablet-Metal-Detector.png" alt="img 5" className="w-full h-64 object-cover transform group-hover:scale-105 transition duration-300 ease-in-out" />
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out">
              <span className="text-white text-lg font-semibold"> Tablet Metal Detector</span>
            </div>
          </div>
          {/* <!-- 6nd img --> */}
          <div className="relative group overflow-hidden rounded-lg shadow-lg">
            <img src="https://i.postimg.cc/qqwZNJ67/Whats-App-Image-2024-11-13-at-11-43-40-8e5e12a6.jpg" alt="img 6" className="w-full h-64 object-cover transform group-hover:scale-105 transition duration-300 ease-in-out" />
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out">
              <span className="text-white text-lg font-semibold">Manufacturer of Metal Detector</span>
            </div>
          </div>
        ...
        <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden transition-transform transform hover:scale-105">
          <div className="p-6">
            <div className="flex items-center mb-2">
              ...
              <h2 className="tracking-widest text-xs title-font font-mono text-gray-400 "> MICROSCAN METAL DETECTOR</h2>
            </div>
