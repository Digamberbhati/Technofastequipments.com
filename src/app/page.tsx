  ...
  Join us
      ...
      <section className="bg-slate-400 py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-6">
          ...
          {/* <!-- 4nd img --> */}
          <div className="relative group overflow-hidden rounded-lg shadow-lg">
            <img src="https://i.postimg.cc/rwPLwJ5r/Tablet-Metal-Detector.png" alt="Tablet Metal Detector" className="w-full h-64 object-cover transform group-hover:scale-105 transition duration-300 ease-in-out" />
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out">
          ...
          {/* <!-- 6nd img --> */}
          <div className="relative group overflow-hidden rounded-lg shadow-lg">
            <img src="https://i.postimg.cc/zBLvfvLJ/Greavity-Feed-Metal-Detector.png" alt="Greavity Feed Metal Detector" className="w-full h-64 object-cover transform group-hover:scale-105 transition duration-300 ease-in-out" />
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out">
