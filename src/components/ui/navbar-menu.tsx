...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative  border-b border-zinc-700  top-0 shadow-input flex justify-center max-w-screen-xl mx-auto  "
    >
      {children}
    </nav>
  );
...
export const ProductItem = ({
  ...
  return (
    <Link href={href} className="flex space-x-2">
      ...
      />
      <div>
        <h4 className="text-xl font-bold mb-1 text-neutral-200">{title}</h4>
